...
class Reservation extends CI_Controller {
	...
	public function index()
	{
		if (!isset($this->session->reservation_data['logged_in']))
			...
			$data['users'] = $this->room->get_reservations();
	...
	public function day2()
	{
		if (!isset($this->session->reservation_data['logged_in']))
			...
			$data['users'] = $this->room->get_reservations2();
	...
	public function day3()
	{
		if (!isset($this->session->reservation_data['logged_in']))
			...
			$data['users'] = $this->room->get_reservations3();
	...
	public function day4()
	{
		if (!isset($this->session->reservation_data['logged_in']))
			...
			$data['users'] = $this->room->get_reservations4();
