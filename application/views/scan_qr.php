...
<body class="flex items-center justify-center">
    <div id="container" class="w-full h-full flex items-center">
        <div class="h-full">
            <div>
                <div>
                    <img id="header_img" src="../../assets/images/access_header.png" />
                    <dl>
                                ...
                                <div>
                                    ...
                                    <dl class="pl-2">
                                        <div id="qr_nick_name" class="qr_info_wrap">
                                            ...
                                            <div class="info_content"><input type="text" class="qr_info input" value="<?php if (isset($nick_name)) echo $nick_name ?>" readonly>
                                            </div>
                                        </div>
                                        <div id="qr_org" class="qr_info_wrap">
                                            <div class="info_name">소 속</div>
                                            <?php if (mb_strlen($entrance_org) >= 13) { ?>
                                                <div class="info_content"> <input type="text" style="font-size:2rem" class="qr_info input" value="<?php if (isset($entrance_org)) echo $entrance_org ?>" readonly>
                                                </div>
                                            <?php } else { ?>
                                    ...
                                    <dl class="pl-2">
                                        ...
                                        <div id="qr_score" class="qr_info_wrap">
                                            ...
                                            <div class="info_content">
                                                <input style="color:red; background-color:yellow;" class="qr_info input" type="text" value="<?php if (isset($score)) echo $score ?>" readonly>
                                            </div>
                                        </div>
                                    </dl>

                                    <div id="text_box" class="border-2 border-indigo-900 px-5 py-2 ml-2">
...
<script>
    ...
    header_img.addEventListener("touchstart", () => {
