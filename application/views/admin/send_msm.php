...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => array(
            'phone' =>  $phone, 'callback' => '01030098530',  'message' => '
안녕하십니까,
...
[등록안내]
*등록데스크에서 문자 내 ‘QR코드’를 제시 후 명찰을 수령해 주시기 바랍니다.
-위치: 그랜드홀 로비(B1)
-운영 시간: 3월 14일(금) 13:00-20:00 / 3월 15일(토) 07:00-17:20

[기타안내]
*사전에 ‘대한비만학회 춘계학술대회’ 어플리케이션을 설치하신 후 등록데스크를 방문하여 주시기를 요청드립니다. (문자 또는 어플리케이션 내 ‘QR코드’를 제시하시면 명찰을 신속히 수령하실 수 있습니다.)
