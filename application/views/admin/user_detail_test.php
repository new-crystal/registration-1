                    ...
                    <div class="panel-body">
                        <div class="detail_table">
                            <table>
                                <tr>
                                    <th>참가유형</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['type2']; ?>"
                                            name="type2" id="type2"></td>
                                </tr>
                                <tr>
                                    <th>참가자구분</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['type']; ?>"
                                            name="type1" id="type1"></td>
                                </tr>
                                <tr>
                                    <th>회원여부</th>
                                    <td> <select class="form-control input-lg m-bot15" name="type3" id="type3"
                                ...
                                <tr>
                                    <th>평점신청여부</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['etc1']; ?>"
                                            name="etc1" id="etc1"></td>
                                </tr>
                                <tr>
                                    <th>면허번호</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['ln']; ?>"
                                            name="ln" id="ln"></td>
                                </tr>
                                <tr>
                                    <th>전문의번호</th>
                                    <td> <input type="text" class="form-control" value="<?php echo $item['sn']; ?>"
                                            name="sn" id="sn"></td>
                                </tr>
                                <tr>
                                    <th>이름</th>
                                    <td> <input class="form-control" type="text"
                                            value="<?php echo $item['nick_name']; ?>" name="nick_name" id="nick_name">
                                    </td>
                                </tr>
                                <tr>
                                    <th>전화번호</th>
                                ...
                                <tr>
                                    <th>소속</th>
                                    <td> <input class="form-control" type="text" value="<?php echo $item['org']; ?>"
                                            name="org" id="org"></td>
                                </tr>
                                <tr>
                                    <th>소속(네임택용)</th>
                                ...
                                <tr>
                                    ...
                                    <td> <input id="dp1" type="text" value="<?php echo $item['deposit_date']; ?>"
                                            size="16" class="form-control" name="deposit_date"></td>
                                </tr>
                                <tr>
                                    <th>메모</th>
                                ...
                                <tr>
                                    ...
                                    <td> <input id="time" type="text" value="<?php echo substr($item['time'], 0, 10) ?>"
                                            size="16" class="form-control" name="time"></td>
                                </tr>
                            </table>
                        </div>
                        <div class="btn_box">
