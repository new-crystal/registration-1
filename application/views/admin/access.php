                ...
                <form action="/admin/access" id="qr_form" name="qr_form" class="w-full h-screen flex flex-col items-center justify-center bg-slate-50">
                    ...
                    <div class="w-2/5 flex flex-col items-center justify-center translate-y-60">
                        ...
                        <div class="flex items-center mx-10">
                            <input id="qrcode" name="qrcode" class="w-[400px] h-[50px] mr-5 p-3 -translate-y-20" type="text" autofocus />

                            <button class="w-[150px] h-[50px] bg-slate-300 hover:bg-slate-400 active:bg-slate-500  text-black -translate-y-20" type="submit" id="submit">등록</button>
                        </div>
                    </div>
