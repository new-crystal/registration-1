...
<!------------------------ 의료 -------------------------->
            ...
            <tr>
                ...
                <th class="bg-blue-200">총합</th>

                <td class="bg-blue-200"><?php echo $sum_t0_d1_pre_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t0_d1_pre_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t0_d1_on_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t0_d1_on_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t0_d2_pre_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t0_d2_pre_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t0_d2_on_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t0_d2_on_ac; ?></td>
...
<tr>
            ...
            <tr>
                ...
                <td class="bg-blue-200"><?php echo $sum_t1_d1_pre_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t1_d1_pre_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t1_d1_on_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t1_d1_on_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t1_d2_pre_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t1_d2_pre_ac; ?></td>

                <td class="bg-blue-200"><?php echo $sum_t1_d2_on_ap; ?></td>
                <td class="bg-blue-200"><?php echo $sum_t1_d2_on_ac; ?></td>
...
<!------------------------ total -------------------------->
            ...
            <tr>
                ...
                <td class="bg-yellow-400" colspan="4"></td>
                <td class="bg-yellow-400" colspan="4"></td>
            </tr>
        </tbody>
    </table>
