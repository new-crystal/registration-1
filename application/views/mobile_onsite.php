                        ...
                        <div class="mo_wrap">
                            ...
                            <div class="mo_wrap">
                                ...
                                <div class="flex justify-between items-center">
                                    <select id="Participation_1" style="background-color:#ffffff;" class="px-2 py-1 w-full h-9 border" name="type2">
                            ...
                            <div style="display: none;" class="mo_wrap">
                                ...
                                <div class="flex justify-between items-center">
                                    <select id="Category_1" style="background-color:#ffffff;" class="px-2 py-1 w-full h-9 border">
                                        <option value="" selected="selected">* 필수 선택사항</option>
...
본 학술대회의 주관사인 대한비만학회는 학술대회 등록시스템 서비스 제공을 위하여 관계 법령에 따라 아래와 같이 개인정보를 수집, 이용하는 내용을 알리오니 자세히 읽으신 후 동의 여부를 결정하여 주십시오.
                        ...
                        <div class="all_checkbox">
                            ...
                            <label for="all_check" class="sn">개인정보 수집 및 제공 동의에 모두 동의</label>
                        </div>
                        <div class="personal_checkbox">
                            <div>
                                <input id="first_check" class="check" type="checkbox" />
                                <label for="first_check" class="sn">개인정보 수집 동의 <span>(필수)</span></label>
                            </div>
...
를 위한 용도 외의 다른 목적으로 사용되지 않습니다.
                        ...
                        <div class="personal_checkbox">
                            <div>
                                ...
                                <label for="second_check" class="sn">개인정보 3자 제공 동의<span>(필수)</span></label>
                            </div>
...
이용할 수 없습니다. 또한 학술대회 출입증 발급이 불가하여 재입장 등 입장의 제한이 발생될 수 있습니다.
                        ...
                        <div class="personal_checkbox">
                            <div>
                                <input id="third_check" class="check" type="checkbox" name="agree1" />
                                <label for="third_check" class="sn"> 차기 학술대회 관련 안내 이메일 수신 동의 <span style="color: #7d8597;">(선택)</span>
                                </label>
                        ...
                        <div class="personal_checkbox">
                            <div>
                                <input id="fourth_check" class="check" type="checkbox" name="agree2" />
                                <label for="fourth_check" class="sn"> 차기 학술대회 관련 안내 휴대폰 번호 수신 동의 <span style="color: #7d8597;">(선택)</span>
                                </label>
